...
An input.pcap file is a Packet Capture (PCAP) data file that contains a record of network traffic. It is essentially a binary log of all communications intercepted on a network during a specific period. 
